...
var shoulderlefty = Math.min(Math.max((results.poseLandmarks[29].x), 0), 1);
var shoulderleftyscaled = (shoulderlefty * 127);
MIDIOutputs[0].send([176, 1, shoulderleftyscaled]);

var shoulderrighty = Math.min(Math.max((results.poseLandmarks[29].y), 0), 1);
var shoulderrightyscaled = (shoulderrighty * 127);
MIDIOutputs[0].send([176, 2, shoulderrightyscaled]);

var rhandx = Math.min(Math.max((results.poseLandmarks[29].z), 0), 0.9);
var rhandxscaled = (rhandx * 127);
MIDIOutputs[0].send([176, 3, rhandxscaled]);

var rhandy = Math.min(Math.max((results.poseLandmarks[30].x), 0), 0.9);
var rhandyscaled = (rhandy * 127);
MIDIOutputs[0].send([176, 4, rhandyscaled]);

var nose = Math.min(Math.max((results.poseLandmarks[30].y), 0), 1);
var nosescaled = (nose * 127);
MIDIOutputs[0].send([176, 5, nosescaled]);

var lhandx = Math.min(Math.max((results.poseLandmarks[30].z), 0), 0.9);
